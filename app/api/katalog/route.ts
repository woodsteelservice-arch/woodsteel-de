  ...
  try {
    const response = await fetch(RESEND_ENDPOINT, {
      ...
      body: JSON.stringify({
        from,
        to: [email],
        subject: "WS Wintergarten Katalog",
        text: [
          "Guten Tag,",
          "",
          "im Anhang senden wir Ihnen den WS Wintergarten Katalog — Pergolen, Wintergärten und Terrassenverglasung.",
          `Falls der Anhang nicht angezeigt wird, können Sie den Katalog hier herunterladen: ${pdfUrl}`,
          "",
